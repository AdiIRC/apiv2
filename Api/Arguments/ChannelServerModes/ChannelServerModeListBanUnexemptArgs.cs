namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    public class ChannelServerModeListBanUnexemptArgs : EventArgs
    {
        ...
        public ChannelServerModeListBanUnexemptArgs(IChannel channel, string byServer, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
