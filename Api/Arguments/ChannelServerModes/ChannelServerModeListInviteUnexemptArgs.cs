namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelServerModeListInviteUnexempt event
    /// </summary>
    public class ChannelServerModeListInviteUnexemptArgs : EventArgs
    {
        ...
        public ChannelServerModeListInviteUnexemptArgs(IWindow window, IServer server, IChannel channel, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the invite unexcempt occured
        /// </summary>
