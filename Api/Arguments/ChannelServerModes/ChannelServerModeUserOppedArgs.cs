namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelServerModeUserOpped event
    /// </summary>
    public class ChannelServerModeUserOppedArgs : EventArgs
    {
        ...
        public ChannelServerModeUserOppedArgs(IChannel channel, IChannelUser user, string byServer, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
        ...
        /// <summary>
        ///     Returns the IChannelUser which got opped
        /// </summary>
