namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    public class ChannelServerModeUserDeowneredArgs : EventArgs
    {
        ...
        public ChannelServerModeUserDeowneredArgs(IChannel channel, IChannelUser user, string byServer, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
