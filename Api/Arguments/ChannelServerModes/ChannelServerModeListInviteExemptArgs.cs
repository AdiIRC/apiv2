namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelServerModeListInviteExempt event
    /// </summary>
    public class ChannelServerModeListInviteExemptArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelServerModeListInviteExempt event
        /// </summary>
        ...
        public ChannelServerModeListInviteExemptArgs(IWindow window, IServer server, IChannel channel, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the invite excempt occured
        /// </summary>
        ...
        /// <summary>
        ///     Returns the IChannel where the invite excempt occured
        /// </summary>
        public IChannel Channel { get { return this.channel; } }

        /// <summary>
        ///     Returns the nick!ident@host mask for this invite excempt
        /// </summary>
