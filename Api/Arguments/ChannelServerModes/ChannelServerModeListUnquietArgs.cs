namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelServerModeListUnquiet event
    /// </summary>
    public class ChannelServerModeListUnquietArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelServerModeListUnquiet event
        /// </summary>
        ...
        public ChannelServerModeListUnquietArgs(IWindow window, IServer server, IChannel channel, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the unquiet occured
        /// </summary>
        ...
        /// <summary>
        ///     Returns the nick!ident@host mask for this unquiet
        /// </summary>
