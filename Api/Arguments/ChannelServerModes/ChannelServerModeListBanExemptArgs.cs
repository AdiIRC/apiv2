namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelServerModeListBanExempt event
    /// </summary>
    public class ChannelServerModeListBanExemptArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelServerModeListBanExempt event
        /// </summary>
        ...
        public ChannelServerModeListBanExemptArgs(IWindow window, IServer server, IChannel channel, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the exempt occured
        /// </summary>
