namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelServerModeUserHalfOpped event
    /// </summary>
    public class ChannelServerModeUserHalfOppedArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelServerModeUserHalfOpped event
        /// </summary>
        ...
        public ChannelServerModeUserHalfOppedArgs(IWindow window, IServer server, IChannel channel, IChannelUser user, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the user got half-opped
        /// </summary>
        ...
        /// <summary>
        ///     Returns the IChannelUser which got half-opped
        /// </summary>
