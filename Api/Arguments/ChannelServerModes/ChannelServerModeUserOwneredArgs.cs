namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelServerModeUserOwnered event
    /// </summary>
    public class ChannelServerModeUserOwneredArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelServerModeUserOwnered event
        /// </summary>
        ...
        public ChannelServerModeUserOwneredArgs(IWindow window, IServer server, IChannel channel, IChannelUser user, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the user got ownered
        /// </summary>
        ...
        /// <summary>
        ///     Returns the IChannel where the user got ownered
        /// </summary>
        public IChannel Channel { get { return this.channel; } }

        /// <summary>
        ///     Returns the IChannelUser which got ownered
        /// </summary>
