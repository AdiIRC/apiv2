namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    public class ChannelServerModeUserDeadminedArgs : EventArgs
    {
        ...
        public ChannelServerModeUserDeadminedArgs(IChannel channel, IChannelUser user, string byServer, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
