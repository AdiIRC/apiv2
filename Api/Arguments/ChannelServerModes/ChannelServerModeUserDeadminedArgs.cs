namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelServerModeUserDeadmined event
    /// </summary>
    public class ChannelServerModeUserDeadminedArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelServerModeUserDeadmined event
        /// </summary>
        ...
        public ChannelServerModeUserDeadminedArgs(IWindow window, IServer server, IChannel channel, IChannelUser user, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the user got deadmined
        /// </summary>
        ...
        /// <summary>
        ///     Returns the IChannelUser which got deadmined
        /// </summary>
