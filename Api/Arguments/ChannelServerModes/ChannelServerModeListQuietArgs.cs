namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelServerModeListQuiet event
    /// </summary>
    public class ChannelServerModeListQuietArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelServerModeListQuiet event
        /// </summary>
        ...
        public ChannelServerModeListQuietArgs(IWindow window, IServer server, IChannel channel, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the quiet occured
        /// </summary>
        ...
        /// <summary>
        ///     Returns the IChannel where the quiet occured
        /// </summary>
        public IChannel Channel { get { return this.channel; } }

        /// <summary>
        ///     Returns the nick!ident@host mask for this quiet
        /// </summary>
