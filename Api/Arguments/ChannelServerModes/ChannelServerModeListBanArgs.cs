namespace AdiIRCAPIv2.Arguments.ChannelServerModes
{
    ...
    public class ChannelServerModeListBanArgs : EventArgs
    {
        ...
        public ChannelServerModeListBanArgs(IWindow window, IServer server, IChannel channel, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
