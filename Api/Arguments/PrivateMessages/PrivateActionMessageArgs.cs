namespace AdiIRCAPIv2.Arguments.PrivateMessages
{
    ...
    /// <summary>
    ///     Arguments class passed to the PrivateActionMessage event
    /// </summary>
    public class PrivateActionMessageArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the PrivateActionMessage event
        /// </summary>
        ...
        public PrivateActionMessageArgs(IServer server, IUser user, string message, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.server = server;
            this.user = user;
