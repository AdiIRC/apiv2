namespace AdiIRCAPIv2.Arguments.PrivateMessages
{
    ...
    /// <summary>
    ///     Arguments class passed to the PrivateCtcpMessage event
    /// </summary>
    public class PrivateCtcpMessageArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the PrivateCtcpMessage event
        /// </summary>
        ...
        public PrivateCtcpMessageArgs(IWindow window, IServer server, IUser user, string message, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
            this.user = user;
