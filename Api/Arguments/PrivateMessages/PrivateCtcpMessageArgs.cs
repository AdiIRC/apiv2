namespace AdiIRCAPIv2.Arguments.PrivateMessages
{
    ...
    public class PrivateCtcpMessageArgs : EventArgs
    {
        ...
        public PrivateCtcpMessageArgs(IServer server, IUser user, string message, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.server = server;
            this.user = user;
