namespace AdiIRCAPIv2.Arguments.PrivateMessages
{
    ...
    /// <summary>
    ///     Arguments class passed to the ServerWallopsMessageArgs event
    /// </summary>
    public class ServerWallopsMessageArgs : EventArgs
    {
        ...
        public ServerWallopsMessageArgs(IServer server, IUser user, string message, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.server = server;
            this.user = user;
