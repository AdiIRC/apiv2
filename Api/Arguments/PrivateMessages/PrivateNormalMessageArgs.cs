namespace AdiIRCAPIv2.Arguments.PrivateMessages
{
    ...
    /// <summary>
    ///     Arguments class passed to the PrivateNormalMessage event
    /// </summary>
    public class PrivateNormalMessageArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the PrivateNormalMessage event
        /// </summary>
        ...
        public PrivateNormalMessageArgs(IWindow window, IServer server, IUser user, string message, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
            this.user = user;
