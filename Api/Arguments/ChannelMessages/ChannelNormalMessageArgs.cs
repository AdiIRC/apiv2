namespace AdiIRCAPIv2.Arguments.ChannelMessages
{
    ...
    public class ChannelNormalMessageArgs : EventArgs
    {
        ...
        public ChannelNormalMessageArgs(IChannel channel, IChannelUser user, string message, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
