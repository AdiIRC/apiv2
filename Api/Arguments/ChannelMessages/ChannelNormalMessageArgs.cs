namespace AdiIRCAPIv2.Arguments.ChannelMessages
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelNormalMessage event
    /// </summary>
    public class ChannelNormalMessageArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelNormalMessage event
        /// </summary>
        ...
        public ChannelNormalMessageArgs(IWindow window, IServer server, IChannel channel, IChannelUser user, string message, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
