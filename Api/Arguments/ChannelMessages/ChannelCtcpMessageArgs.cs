namespace AdiIRCAPIv2.Arguments.ChannelMessages
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelCtcpMessage event
    /// </summary>
    public class ChannelCtcpMessageArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelCtcpMessage event
        /// </summary>
        ...
        public ChannelCtcpMessageArgs(IWindow window, IServer server, IChannel channel, IChannelUser user, string message, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
