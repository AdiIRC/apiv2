namespace AdiIRCAPIv2.Arguments.ChannelMessages
{
    ...
    public class ChannelCtcpMessageArgs : EventArgs
    {
        ...
        public ChannelCtcpMessageArgs(IChannel channel, IChannelUser user, string message, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
