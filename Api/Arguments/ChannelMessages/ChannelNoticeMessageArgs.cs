namespace AdiIRCAPIv2.Arguments.ChannelMessages
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelNoticeMessage event
    /// </summary>
    public class ChannelNoticeMessageArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelNoticeMessage event
        /// </summary>
        ...
        public ChannelNoticeMessageArgs(IChannel channel, IChannelUser user, string message, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
