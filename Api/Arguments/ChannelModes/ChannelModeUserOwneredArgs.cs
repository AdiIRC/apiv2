namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    public class ChannelModeUserOwneredArgs : EventArgs
    {
        ...
        public ChannelModeUserOwneredArgs(IChannel channel, IUser user, IChannelUser byUser, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
