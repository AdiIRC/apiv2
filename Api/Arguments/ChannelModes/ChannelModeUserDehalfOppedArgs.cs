namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelModeUserDehalfOpped event
    /// </summary>
    public class ChannelModeUserDehalfOppedArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelModeUserDehalfOpped event
        /// </summary>
        ...
        public ChannelModeUserDehalfOppedArgs(IWindow window, IServer server, IChannel channel, IUser user, IChannelUser byUser, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the user got de-halfopped
        /// </summary>
        ...
        /// <summary>
        ///     Returns the IChannel where the user got de-halfopped
        /// </summary>
        public IChannel Channel { get { return this.channel; } }

        /// <summary>
        ///     Returns the IUser which got de-halfopped
        /// </summary>
