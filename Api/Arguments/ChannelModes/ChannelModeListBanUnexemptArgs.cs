namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelModeListBanUnexempt event
    /// </summary>
    public class ChannelModeListBanUnexemptArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelModeListBanUnexempt event
        /// </summary>
        ...
        public ChannelModeListBanUnexemptArgs(IWindow window, IServer server, IChannel channel, IUser byUser, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the ban unexempt occured
        /// </summary>
        ...
        /// <summary>
        ///     Returns the IChannel where the ban unexempt occured
        /// </summary>
        ...
        /// <summary>
        ///     Returns the nick!ident@host mask for this ban unexempt
        /// </summary>
