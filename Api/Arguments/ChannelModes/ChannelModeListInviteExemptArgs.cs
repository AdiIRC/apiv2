namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    public class ChannelModeListInviteExemptArgs : EventArgs
    {
        ...
        public ChannelModeListInviteExemptArgs(IChannel channel, IUser byUser, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
