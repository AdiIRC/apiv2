namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelModeUserDeopped event
    /// </summary>
    public class ChannelModeUserDeoppedArgs : EventArgs
    {
        ...
        public ChannelModeUserDeoppedArgs(IWindow window, IServer server, IChannel channel, IUser user, IChannelUser byUser, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the user got de-opped
        /// </summary>
        ...
        /// <summary>
        ///     Returns the IUser which got de-opped
        /// </summary>
