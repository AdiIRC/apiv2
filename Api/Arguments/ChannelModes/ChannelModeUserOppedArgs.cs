namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelModeUserOpped event
    /// </summary>
    public class ChannelModeUserOppedArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelModeUserOpped event
        /// </summary>
        ...
        public ChannelModeUserOppedArgs(IWindow window, IServer server, IChannel channel, IUser user, IChannelUser byUser, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IUser which got opped
        /// </summary>
