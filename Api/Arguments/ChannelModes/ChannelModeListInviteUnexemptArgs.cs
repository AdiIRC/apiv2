namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    public class ChannelModeListInviteUnexemptArgs : EventArgs
    {
        ...
        public ChannelModeListInviteUnexemptArgs(IChannel channel, IUser byUser, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
