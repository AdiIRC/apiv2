namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelModeListInviteUnexempt event
    /// </summary>
    public class ChannelModeListInviteUnexemptArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelModeListInviteUnexempt event
        /// </summary>
        ...
        public ChannelModeListInviteUnexemptArgs(IWindow window, IServer server, IChannel channel, IUser byUser, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the invite unexempt occured
        /// </summary>
        ...
        /// <summary>
        ///     Returns the IChannel where the invite unexempt occured
        /// </summary>
        ...
        /// <summary>
        ///     Returns the nick!ident@host mask for this invite unexempt
        /// </summary>
