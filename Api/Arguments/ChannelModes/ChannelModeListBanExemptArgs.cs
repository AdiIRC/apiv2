namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    public class ChannelModeListBanExemptArgs : EventArgs
    {
        ...
        public ChannelModeListBanExemptArgs(IWindow window, IServer server, IChannel channel, IUser byUser, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the ban exempt occured
        /// </summary>
