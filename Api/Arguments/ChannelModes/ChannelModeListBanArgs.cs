namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    public class ChannelModeListBanArgs : EventArgs
    {
        ...
        public ChannelModeListBanArgs(IChannel channel, IUser byUser, string banMask, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
