namespace AdiIRCAPIv2.Arguments.ChannelModes
{
    ...
    /// <summary>
    ///     Arguments class passed to the ChannelModeUserDevoiced event
    /// </summary>
    public class ChannelModeUserDevoicedArgs : EventArgs
    {
        ...
        /// <summary>
        ///     Constructor for arguments class passed to the ChannelModeUserDevoiced event
        /// </summary>
        ...
        public ChannelModeUserDevoicedArgs(IWindow window, IServer server, IChannel channel, IUser user, IChannelUser byUser, bool modeFirst, bool modeLast, string rawMessage, string rawBytes, DateTime serverTime, IDictionary<string, string> messageTags, EatData eatData)
        {
            this.window = window;
            this.server = server;
        ...
        /// <summary>
        ///     Returns the IWindow where the user got de-voiced
        /// </summary>
        ...
        /// <summary>
        ///     Returns the IChannel where the user got de-voiced
        /// </summary>
        public IChannel Channel { get { return this.channel; } }

        /// <summary>
        ///     Returns the IUser which got de-voiced
        /// </summary>
